...
<canvas id="viewcanvas" resize keepalive="true"></canvas>
	...
	<div id="intro"></div>
	<div id="intro-container"><img src="images/beginning.png" id="beginning-img" width="360" height="300" alt="beginning info" /><a href="seismi.php" id="tryagain"><img src="images/button-tryagain.png" width="300" height="100" alt="problems loading, please try again" /></a></div>
	<?php 
