 ...
 * Version 0.6.0 beta
 * Author Abel Mohler
 * Modifications by Gokce Taskan
 * Implemented proper storing for settings. This way Callbacks work
 * Added callBefore and callAfter inside _move function so they are called when method is called manually without mousewheel
...
(function($) {// jQuery.noConflict compliant
    $.fn.mapbox = function(o, callback) {
        ...
        // Callbacks were not working becuase setting were not stored properly
        // Settings are now stored and not modified after init
        if (!$this.data('mapbox')) {
            o = $.extend(defaults, o || {});
            this.data('mapbox',o);
        }
        ...
        function _move(x, y, node) {
            ...
            var xPrev = $(node).css('left');
            var yPrev = $(node).css('top');
            ...
            var xDisp = left + _makeCoords(xPrev);
            var yDisp = top + _makeCoords(yPrev);
            o.callAfter(node[0], xDisp, yDisp, this);
        }
                ...
                */
                ...
                if(o.mousewheel && typeof $.fn.mousewheel != "undefined") {
                    $(viewport).mousewheel(function(e, distance) {
                        ...
                        if(_zoom.call(this, distance) && o.zoomToCursor) {
